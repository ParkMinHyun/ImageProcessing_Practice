...
int main() {
	...
	IplImage* rotationImage = cvCreateImage(cvSize(lena->width, lena->height), lena->depth, lena->nChannels); // 합성된 이미지 생성
	...
	scaleDownImage = Rotation(scaleDownImage, rotationImage);
